        ...
        <div class="mx-auto max-w-[68.75rem]">
            <div class="mb-7 flex items-center justify-between">
                ...
                <div class="flex gap-2.5">
                    <a btn class="inverse gap-1" routerLink="/import">
                        <app-icon class="text-base">upload_file</app-icon>
                        Import SVG
                    </a>
                    <button
                        btn
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        ...
                        >
                            <input
                                ...
                                [ngModel]="form_name()"
                                (ngModelChange)="form_name.set($event)"
                        ...
                        >
                            <input
                                ...
                                (ngModelChange)="form_building.set($event)"
                                [ngModelOptions]="{ standalone: true }"
                            />
                        </mat-form-field>
                    </div>
            ...
            @if (loading()) {
                ...
                >
                    ...
                    >
                        <app-icon class="text-base">add</app-icon>
                        New Project
                    </button>
                </div>
            } @else {
