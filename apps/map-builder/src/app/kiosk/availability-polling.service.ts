 ...
 */
@Injectable()
export class AvailabilityPollingService implements OnDestroy {
    ...
    public start(objects: MapObject[], level_zone_id = '') {
        ...
        this._timers.push(setTimeout(() => this._poll(), FIRST_POLL_MS));
        this._timers.push(setInterval(() => this._poll(), POLL_INTERVAL_MS));
    }
