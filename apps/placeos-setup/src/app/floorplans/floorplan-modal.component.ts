        ...
        >
            ...
            >
                ...
                <div class="w-full py-2">
                    ...
                    >
                        Is Map file available as high quaility PDF, JPEG or PNG?
                    </mat-checkbox>
                </div>
                <div class="w-full py-2">
                    <mat-checkbox
                    ...
                    >
                        Are fixed points of interest intended to be searchable
                        or bookable identified (rooms, desks, phone booths)
                        setup? Each with an ID that matches the ID in the
                        RoomID/DeskID tabs in this spreadsheet.
                    </mat-checkbox>
                </div>
                <div class="w-full py-2">
                    <mat-checkbox
