...
@Component({
    ...
    template: `
        <header
            class="flex w-full items-center justify-between border-b border-gray-300 bg-white p-2 dark:border-neutral-500 dark:bg-neutral-700"
        >
        ...
        <main class="flex flex-wrap bg-gray-200 p-2 dark:bg-neutral-600">
            <div
                class="m-2 flex-grow-1 rounded border border-gray-300 bg-white dark:border-neutral-500 dark:bg-neutral-700"
            >
                <h3
                    class="w-full border-b border-gray-300 p-2 dark:border-neutral-500"
                >
                    Workplace
                </h3>
                <div class="flex max-w-[24rem] flex-wrap">
...
export class InterfaceDetailsModalComponent {
    private readonly _data = signal(inject<Interface>(MAT_DIALOG_DATA));

    public readonly item = computed(() => this._data());
}
