...
@Component({
    ...
    template: `
        ...
        >
            <header
                class="flex w-full flex-col space-y-2 border-b border-gray-200 bg-blue-300 dark:border-neutral-500 dark:bg-neutral-700"
            >
            ...
            @if (!loading()) {
                ...
                <footer
                    class="flex w-full flex-col space-y-2 border-t border-gray-200 bg-blue-300 dark:border-neutral-500 dark:bg-neutral-700"
                >
