...
@Component({
    ...
    template: `
        ...
        >
            ...
            >
                <div
                    class="relative mx-auto w-[640px] max-w-full p-4 text-center"
                >
            ...
            @if (!loading()) {
                <main
                    class="mx-auto h-1/2 w-[640px] max-w-full flex-1 overflow-auto p-4"
                    [formGroup]="form()"
                >
                    <div class="w-full">
                    ...
                    <div class="w-full">
                        ...
                        <mat-form-field appearance="outline" class="w-full">
                            ...
                            />
                            <mat-hint>
                                City that the building resides in
                            </mat-hint>
                    ...
                    <div class="w-full">
                        ...
                        <mat-form-field appearance="outline" class="w-full">
                            ...
                            />
                            <mat-hint>
                                Address within the city that the building
                                resides at
                            </mat-hint>
                    ...
                    <div class="w-full">
                        ...
                        <mat-form-field appearance="outline" class="w-full">
                            ...
                            <mat-hint>
                                Currency that transactions are resolved in
                                within the building
                            </mat-hint>
                ...
                >
                    <div class="relative mx-auto w-[640px] max-w-full p-4">
...
export class OrganisationBuildingModalComponent {
    ...
    public readonly country_list = signal(COUNTRIES);
    public readonly currency_list = signal(CURRENCIES);
