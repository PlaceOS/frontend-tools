            ...
            >
                ...
                <div class="w-full">
                    ...
                    <mat-form-field appearance="outline" class="w-full">
                        ...
                        />
                        <mat-hint> Organisational name for the space </mat-hint>
                ...
                <div class="w-full">
                    ...
                    <mat-form-field appearance="outline" class="w-full">
                        <mat-chip-list #featureList aria-label="Room Features">
                        ...
                        <mat-hint>
                            Resources in the room that are available for users.
                        </mat-hint>
                        <mat-error>Display name is required</mat-error>
                    </mat-form-field>
                </div>
                ...
                <div class="w-full py-2">
                    <mat-checkbox name="visitors" formControlName="visitors">
                ...
                <div class="w-full">
                    <label for="auto-release-delay">Auto-release delay</label>
                    <mat-form-field appearance="outline" class="w-full">
                        <input
                            matInput
                        ...
                        />
                        <mat-hint>
                            Duration in minutes after the start of the booking
                        </mat-hint>
                        <mat-error>Auto-release delay is required</mat-error>
                    </mat-form-field>
                </div>
                }
                <div class="w-full py-2">
...
export class SpaceModalComponent {
    private _data = inject<Space>(MAT_DIALOG_DATA);
