                ...
                >
                    ...
                    <div class="w-full">
                        ...
                        <mat-form-field appearance="outline" class="w-full">
                            ...
                            <mat-hint>
                                Resources in the Car Space that are available
                                for users.
                            </mat-hint>
                    ...
                    <div class="w-full py-2">
                        ...
                        >
                            Should recurring bookings be allowed in this
                            car space?
                        </mat-checkbox>
                    </div>
...
export class CarSpaceModalComponent {
    @Output() public readonly onSave = new EventEmitter<Partial<CarSpace>>();
